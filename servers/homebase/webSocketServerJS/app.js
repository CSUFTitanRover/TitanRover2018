...
try {
  ...
  xboxdrv.stdout.on('data', (data) => {
    ...
    if (available !== null) console.log("The Xbox controller has been attached");
    else if(available === null && capture === null) console.log("No attachment");
...
let launchSocket = () => {
    ...
    io.on('connection', function(socketClient) {
      ...
      setInterval(() => { socketClient.emit('broadcast', cData); }, 7);
    });
